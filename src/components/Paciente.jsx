...
export const Paciente = ({paciente}) => {
    ...
    const { email, fecha, nombre, sintomas, propietario, _id} = paciente;
  ...
  return (
    <>
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <p className="font-bold uppercase text-indigo-700 my-2">Contacto: {''}<span className="font-normal normal-case text-black">{email}</span></p>
